...
/*
  Este arquivo popula o banco com algumas poções iniciais.

  Como o banco SQLite está em memória, os dados somem quando o servidor é desligado.
  Por isso, sempre que o servidor inicia, cadastramos essas poções novamente.

  Aqui usamos as URLs oficiais das imagens das poções.
*/
